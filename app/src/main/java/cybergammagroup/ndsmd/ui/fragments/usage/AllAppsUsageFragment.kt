package cybergammagroup.ndsmd.ui.fragments.usage
...
import cybergammagroup.ndsmd.databinding.AppUsageItemBinding
import cybergammagroup.ndsmd.databinding.DialogPermissionInfoBinding
import cybergammagroup.ndsmd.databinding.FragmentAllAppUsageBinding
import cybergammagroup.ndsmd.ui.activity.FragmentActivity
import cybergammagroup.ndsmd.ui.activity.SelectAppsActivity
import cybergammagroup.ndsmd.utils.SavedPreferencesLoader
import cybergammagroup.ndsmd.utils.TimeTools
import cybergammagroup.ndsmd.utils.UsageStatsHelper
import cybergammagroup.ndsmd.utils.getDefaultLauncherPackageName
...
class AllAppsUsageFragment : Fragment() {
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.add_shortcut_usage_tracker -> {
                        ...
                        val shortcutInfo =
                            ShortcutInfoCompat.Builder(requireContext(), "ndsmd_usage_tracker")
    ...
    private fun makeUsageStatsPermissoinDialog() {
        ...
        dialogBinding.desc.text =
            "ndsmd requires device usage access to monitor apps, helping you manage screen time effectively and stay focused on your goals. Rest assured, all data stays securely on your device and is never shared with anyone, ensuring your privacy is fully protected."
        ...
        dialogBinding.btnAccept.setOnClickListener {
            Toast.makeText(requireContext(), getString(R.string.find_and_press_enable, "NDSMD"), Toast.LENGTH_LONG)
                .show()
