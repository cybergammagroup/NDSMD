package cybergammagroup.ndsmd.ui.activity
...
import cybergammagroup.ndsmd.databinding.ActivityMainBinding
import cybergammagroup.ndsmd.databinding.DialogPermissionInfoBinding
import cybergammagroup.ndsmd.databinding.DialogRemoveAntiUninstallBinding
import cybergammagroup.ndsmd.receivers.AdminReceiver
import cybergammagroup.ndsmd.services.AppBlockerService
import cybergammagroup.ndsmd.services.GeneralFeaturesService
import cybergammagroup.ndsmd.services.KeywordBlockerService
import cybergammagroup.ndsmd.services.UsageTrackingService
import cybergammagroup.ndsmd.services.ViewBlockerService
import cybergammagroup.ndsmd.ui.dialogs.StartFocusMode
import cybergammagroup.ndsmd.ui.dialogs.TweakAppBlockerWarning
import cybergammagroup.ndsmd.ui.dialogs.TweakGrayScaleMode
import cybergammagroup.ndsmd.ui.dialogs.TweakKeywordBlocker
import cybergammagroup.ndsmd.ui.dialogs.TweakKeywordPack
import cybergammagroup.ndsmd.ui.dialogs.TweakUsageTracker
import cybergammagroup.ndsmd.ui.dialogs.TweakViewBlockerCheatHours
import cybergammagroup.ndsmd.ui.dialogs.TweakViewBlockerWarning
import cybergammagroup.ndsmd.ui.fragments.anti_uninstall.ChooseModeFragment
import cybergammagroup.ndsmd.ui.fragments.installation.AccessibilityGuide
import cybergammagroup.ndsmd.ui.fragments.installation.WelcomeFragment
import cybergammagroup.ndsmd.ui.fragments.usage.AllAppsUsageFragment
import cybergammagroup.ndsmd.utils.SavedPreferencesLoader
import cybergammagroup.ndsmd.utils.ZipUtils
...
//                makeStartFocusModeDialog()
    ...
    private fun setupClickListeners() {
            ...
            if (!isDeviceAdminOn) {
                ...
                if (binding.antiUninstallWarning.visibility == View.GONE) {
                    ...
                    makeAccessibilityInfoDialog(
                        getString(R.string.general_features_accessibility),
        ...
        binding.monochromeStatusChip.setOnClickListener {
            if(!isGeneralSettingsOn){
                makeAccessibilityInfoDialog(getString(R.string.general_features_accessibility), GeneralFeaturesService::class.java)
                return@setOnClickListener
            }
        ...
        binding.keywordBlockerStatusChip.setOnClickListener {
            makeAccessibilityInfoDialog(getString(R.string.keyword_blocker_accessibility), KeywordBlockerService::class.java)
        }
        binding.focusModeStatusChip.setOnClickListener {
            makeAccessibilityInfoDialog(getString(R.string.app_blocker_accessibility), AppBlockerService::class.java)
        }
        binding.appBlockerStatusChip.setOnClickListener {
            makeAccessibilityInfoDialog(getString(R.string.app_blocker_accessibility), AppBlockerService::class.java)
        }
        binding.viewBlockerStatusChip.setOnClickListener {
            makeAccessibilityInfoDialog(getString(R.string.view_blocker_accessibility), ViewBlockerService::class.java)
        }
        binding.usageTrackerStatusChip.setOnClickListener {
            if (!isDisplayOverOtherAppsOn) {
                makeDrawOverOtherAppsDialog()
            } else {
                makeAccessibilityInfoDialog(getString(R.string.usage_tracker_accessibility), UsageTrackingService::class.java)
            }
        }
        ...
        binding.btnTelegram.setOnClickListener {
            openUrl("https://t.me/ndsmd6")
        }
        binding.btnGithub.setOnClickListener {
            openUrl("https://github.com/cybergammagroup6/ndsmd")
        }
        binding.btnInstagram.setOnClickListener {
            openUrl("https://www.instagram.com/ndsmd.app")
        }
        binding.btnDonate.setOnClickListener {
            openUrl("https://ndsmd.life/donate")
        }

        binding.btnCredits.setOnClickListener {
            //openUrl("https://ndsmd.life/credits")
    ...
    private fun checkPermissions() {
        ...
        lifecycleScope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                if(isGeneralSettingsOn){
                    binding.monochromeWarning.text = "Authorize ndsmd to access Shizuku"
                    if(isShizukuBinderRecieved){
    ...
    private fun showDonationDialog() {
        ...
        if (!(sharedPreferences.getBoolean("is_donation_alerted", false))) {
            ...
            if (daysPassed > 5L) {
                ...
                MaterialAlertDialogBuilder(this)
                    .setTitle(getString(R.string.thank_for_using_ndsmd))
                    .setMessage(
                       getString(R.string.thank_for_using_ndsmd_text)
                    )
    ...
    private fun makeDrawOverOtherAppsDialog() {
        ...
        dialogDisplayOverOtherApps.title.text =
            getString(R.string.enable_2, R.string.display_over_apps)
        ...
        dialogDisplayOverOtherApps.btnAccept.setOnClickListener {
            ...
            Toast.makeText(
                this,
                getString(R.string.find_ndsmd_and_press_enable), Toast.LENGTH_LONG
            ).show()
            val intent = Intent(
    ...
    private fun makeAccessibilityInfoDialog(title: String, cls: Class<*>) {
        ...
        dialogAccessibilityServiceInfoBinding.btnAccept.setOnClickListener {
            Toast.makeText(this, getString(R.string.find_and_press_enable, "$title"), Toast.LENGTH_LONG).show()
    ...
    private fun createFocusModeShortcut() {
        ...
        val shortcutInfo = ShortcutInfoCompat.Builder(this, "ndsmd_focus_mode")
    ...
    data class WarningData(
        val message: String = "Custom Message / Message Personnalisé",
