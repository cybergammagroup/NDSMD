...
import cybergammagroup.ndsmd.databinding.ActivityUsageMetricsBinding
...
import cybergammagroup.ndsmd.views.CustomMarkerView
import java.io.File
...
class UsageMetricsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareStats.setOnClickListener {
            binding.btnDigiWelbeing.text = "Tracked Using ndsmd"
