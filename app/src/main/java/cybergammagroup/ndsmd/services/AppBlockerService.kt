...
import cybergammagroup.ndsmd.blockers.AppBlocker
import cybergammagroup.ndsmd.blockers.FocusModeBlocker
import cybergammagroup.ndsmd.ui.activity.MainActivity
import cybergammagroup.ndsmd.ui.activity.WarningActivity
import cybergammagroup.ndsmd.utils.getCurrentKeyboardPackageName
...
class AppBlockerService : BaseBlockingService() {
    ...
    companion object {
         ...
         */
        const val INTENT_ACTION_REFRESH_APP_BLOCKER = "cybergammagroup.ndsmd.refresh.appblocker"
        ...
        const val INTENT_ACTION_REFRESH_APP_BLOCKER_COOLDOWN =
            "cybergammagroup.ndsmd.refresh.appblocker.cooldown"

        /**
         * Refreshes information related to focus mode.
         */

        const val INTENT_ACTION_REFRESH_FOCUS_MODE = "cybergammagroup.ndsmd.refresh.focus_mode"
    }
